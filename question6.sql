...
insert into Loan values (304, 2264, 491911, 100000);
insert into Loan values (195, 8261, 961914, 500000);
insert into Loan values (943, 8261, 471345, 250000);
insert into Loan values (821, 6045, 19784, 100000);
insert into Loan values (172, 8261, 947941, 250000);
...
insert into Loan values (928, 8261, 139177, 100000);
insert into Loan values (195, 8503, 797216, 1000000);
insert into Loan values (821, 8503, 442931, 250000);
insert into Loan values (317, 8503, 176691, 500000);
