...
insert into Faculty values(12983, 101, "Darshan S", "M.Tech", 12, "Mech", "Munnar");
...
from Faculty f, College c
where experience>=10 and f.qualification!= "M.Tech" and c.college_code = f.college_code and c.college_name="CET";
-- 3
